    ...
    function Viewer(element, options) {
        ...
        this.search = (function () {
            ...
            var normalizePresetSearchTerm = function(term, globalOptions, highlightColor, fixed){
                term.matchingOptions = term.matchingOptions || {};
                var normalizedTerm = {
                    matchingOptions: {},
                };

                normalizedTerm.description = (typeof term.description === 'undefined') ? term.searchTerm : term.description;

                if (typeof term.type !== "undefined") {
                    normalizedTerm.type = term.type;
                }

                if (typeof term.distance !== "undefined") {
                    normalizedTerm.distance = term.distance;
                }
                ...
                if (typeof term.fixed !== "undefined") {
                    normalizedTerm.fixed = term.fixed;
                } else if (typeof term.fixed === "undefined" && typeof fixed !== 'undefined') {
